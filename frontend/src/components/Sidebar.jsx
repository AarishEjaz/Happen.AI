...
// import { SquarePen,Hash,Image,House, Scissors, Eraser, FileText, Users, Icon} from 'lucide-react'
...
//                 item-center gap-3 rounded ${isActive?'bg-gradient-to-r from-[#3C81F6] to-[#9234EA] text-white':''}`}>
//                   {
//                     ({isActive})=>(
//                       <>

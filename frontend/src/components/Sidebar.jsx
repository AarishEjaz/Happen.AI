...
import { SquarePen,Hash,Image,House, Scissors, Eraser, FileText, LogOut,Users} from 'lucide-react'
  ...
  return (
    ...
    transition-all duration-300 ease-in-out`}>
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
        ...
        <LogOut onClick={signOut} className='w-2.5 text-gray-400 hover:text-gray-700 transition cursor-pointer'/>
      </div>
    </div>
  )
}
...
// import { SquarePen, Hash, Image, House, Scissors, Eraser, FileText, Users } from 'lucide-react'
// import { NavLink } from 'react-router-dom'

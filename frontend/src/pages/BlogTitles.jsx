...
//               className={`text-xs px-4 py-1 border rounded-full cursor-pointer ${selectedCategory.text===item.text?'bg-purple-50 text-purple-700':'text-gray-500 border-gray-300'}`} key={item} >{item}</span>
//             ))
//           }
//         </div>
//         <br/>

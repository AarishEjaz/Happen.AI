...
// // ✅ Fixed: baseURL instead of baseUrl
// axios.defaults.baseURL = import.meta.env.VITE_BASE_URL
...
//       console.log('Base URL:', axios.defaults.baseURL); // Check this
//       console.log('Calling:', '/api/ai/generate-article');

//       // ✅ Fixed: added selectedLength.length
...
//       toast.error(error.message)
//     }finally{
//       setLoading(false) // ✅ Better to use finally
//     }
//   }

//   return (
//     // ✅ Fixed: flex-wrap instead of flex wrap
//     <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
//       {/* left col */}
//       <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
//         <div className='flex items-center gap-3'>
...
//         </div>
//         <br/>
//         {/* ✅ Fixed: removed onSubmit, kept type="submit" */}
//         <button 
//           type="submit"
//           disabled={loading}
//           className='w-full flex justify-center items-center gap-2 
//           bg-gradient-to-r from-[#226BFF] to-[#65ADFF] 
//           text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed'
//         >
//           {
//             loading ? 
